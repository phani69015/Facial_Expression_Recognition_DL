...
checkpoint = ModelCheckpoint("seq_model_weights.h5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
with open('seq_training_history.pkl', 'wb') as file:
